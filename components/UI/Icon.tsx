...
const Icons = {
  ...
  GitHub: { Icon: <SiGithub />, color: "group-hover:text-slate-800" },
  Linkedin: { Icon: <SiLinkedin />, color: "group-hover:text-blue-500" },
  Youtube: { Icon: <SiYoutube />, color: "group-hover:text-red-500" },
  Twitter: { Icon: <SiTwitter />, color: "group-hover:text-blue-500" },
  Instagram: { Icon: <SiInstagram />, color: "group-hover:text-pink-500" },
}
