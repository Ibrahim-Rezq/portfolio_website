...
const Card = ({ children, data: { title, iconName } }: CardProps) => {
    ...
    <article className="group flex justify-center items-center flex-col  my-4">
      <span className={"z-10 "}>
        <Icon
          ...
          classes="text-3xl group-hover:scale-150 duration-300 mr-0"
        />
      </span>
      <section
        data-before={title}
        className={
          "h-10 w-32 text-2xl text-center before:z-20 mt-2 overflow-hidden relative " +
          roomClass
        }
      ></section>
    </article>
